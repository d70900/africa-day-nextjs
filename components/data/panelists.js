const panelists = [
  ...
  },
  {
    ...
    summary:
      "Owen joined Transcorp as the Executive Director, Corporate Services in July 2018, and later appointed as the Managing Director and Chief Executive Officer of Transcorp Hotels Plc, leading the brand's operation of its flagship Transcorp Hilton Abuja and Transcorp Hotels Calabar Director. In March 2020, she was became the President/Chief Executive Officer of Transcorp after her appointment to the role, she became the youngest CEO on the Nigerian Stock Exchange and also the youngest and first female to occupy the position at Transcorp Group. Owen is a member of the Board of Trustees of the Association of Power Generation Companies (APGC) in Nigeria, an association for power generation companies representing the interests of developers and operators of independent energy facilities. She holds Non-Executive Director positions in various companies including Transcorp Power Limited, Transcorp Hotels Plc and Avon Healthcare Limited, where she sits on the Board’s Finance, Investment & Risk Committee, and Audit & Governance Committee.​",
  },
  {
    id: 3,
    name: 'Hilda Bassey',
  ...
  },
  {
    ...
    designation: 'panelist',
    summary:
      '<p>Founder, Banke Lawson started the Banke Kuku brand started as a soft furnishing brand before moving to textiles, after completing a major program in Textile Designing from the Arts and Design College, London. From there, Banke as Founder and Creative Director, seeped into one of the major parts of fashion – designing. This journey and determination to make a success out of the brand have since granted her access to various high sits and tables in the fashion sphere, translating into both national and international markets like China, Japan, and Dakar.<br /><br /><blockquote>"The world of fashion designing is a journey, and you really have to go through the whole process. Know who you are as a person, so people can enjoy the brand you project to them. This takes time, understanding and patience. Because fashion is very fast-paced, we need to learn to adapt; out with the old, in with the new."</blockquote>-Banke Kuku, CEO & Founder, Banke Kuku.</p>',
  },
  {
    id: 6,
    name: 'Henry Dottey',
    ...
    summary:
      '<p>Nii is is an experienced communications and corporate relations professional with strong cross-industry experience spanning mainstream media, major governmental areas, and private financial service sectors. Highly driven and self-motivated senior manager with a vision for excellence and drive to deliver through a team of achievers in a competitive and world-class business environment. Proven track record and significant career achievements in corporate communications and government relations.<br />He is an Accredited Member of the Institute of Public Relations, Ghana, and elected as the Honorary Secretary since 2013. He was inducted as the Vice President of the Institute since March 2020 and is presently the Head of Marketing and Corporate communications, UBA Ghana.</p>',
  },
];
